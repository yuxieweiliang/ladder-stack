...
const config = {
  entry: {
    'home/index': path.join(__dirname,'./src/page/index'),
    'login/index': path.join(__dirname,'./src/page/login'),
    'register/index': path.join(__dirname,'./src/page/register'),

    'book/index': path.join(__dirname,'./src/page/book'),
    'bookList/index': path.join(__dirname,'./src/page/bookList'),
    'bookNew/index': path.join(__dirname,'./src/page/bookNew'),
    'bookDetailed/index': path.join(__dirname,'./src/page/bookDetailed'),
    // main: './index.js',
    // 将所有公用的东西都放在一个文件里
  ...
  resolve: {
    extensions: ['.scss', '.less',  '.js', '.jsx', '.htm', '.json', '.html', '.es6'],
